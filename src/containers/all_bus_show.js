    ...
    renderStudents(students)  {
        return students.map( (student) => {
            ...
            <div key={student.id}>
                ...
                {student.inBus === 'TEMP' ? "Visiting" : ''}
                {student.inBus === 'ABSENT' ? 'Waiting' : ''}<br/>
                <br/><br/>
                </div>
            );
        });
                        ...
                        <table>
                            ...
                            <tr>
                                <td style={{width: '500px'}}>
                                    ...
                                    {this.props.busId !== null ? <img style={{border:'ridge', width:'125px', height:'125px'}} alt="Embedded Image" src={srcFront} />:''}
                                    {this.props.busId !== null ? <img style={{border:'ridge', width:'125px', height:'125px'}} alt="Embedded Image" src={srcBack} />:''} <br/>
                                    {this.props.busId !== null ? 'Car Number: ' + this.props.buses[this.props.busId]['carNumber'] : ''}
                                    <br/>
                                    {this.props.busId !== null ? 'Average Velocity: ' + this.props.buses[this.props.busId]['avgVelocity'] : ''}
                                    <br/>
...
function mapStateToProps (state) {
    return { buses:state.aboutBus.buses, busId:state.aboutBus.busId, teachers:state.aboutBus.teachers,
        students:state.aboutBus.students, driver:state.aboutBus.driver, busImg:state.busImg };
}
